...
from langgraph_investigation_agent.app.graph.nodes import generate_hypotheses_node, generate_final_report_node, initialize_state_node
...
async def test_llm_failure_does_not_produce_fake_75_confidence():
    ...
    with patch("langgraph_investigation_agent.app.analysis.hypotheses.safe_invoke_structured_llm", new_callable=AsyncMock) as mock_invoke:
