...
class AgentConfig:
    ...
    EXTRACTION_LLM_MODEL: str = os.getenv("EXTRACTION_LLM_MODEL") or DEFAULT_LLM_MODEL
    REASONING_LLM_MODEL: str = os.getenv("REASONING_LLM_MODEL") or DEFAULT_LLM_MODEL
    FALLBACK_LLM_MODEL: str = os.getenv("FALLBACK_LLM_MODEL") or DEFAULT_LLM_MODEL
    VISION_LLM_MODEL: str = os.getenv("VISION_LLM_MODEL") or DEFAULT_LLM_MODEL
